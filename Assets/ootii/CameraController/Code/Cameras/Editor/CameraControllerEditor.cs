...
namespace com.ootii.Cameras
{
    ...
    public class CameraControllerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorHelper.BoolField("Keep Upright", "Forces the camera to have no z rotation", mTarget.KeepUpright, mTarget))
            {
                mIsDirty = true;
                mTarget.KeepUpright = EditorHelper.FieldBoolValue;
            }
