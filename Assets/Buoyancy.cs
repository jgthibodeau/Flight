...
//	{
//		RaycastHit hit;
//		Debug.DrawRay (Util.RigidBodyPosition (rigidBody), Vector3.down*20, Color.yellow);
//		Debug.DrawRay (Util.RigidBodyPosition (rigidBody), Vector3.up*20, Color.yellow);
//		if (Physics.Raycast (Util.RigidBodyPosition (rigidBody), Vector3.down, out hit, 20, oceanLayer)) {
//			return CalculateOceanLevelFromMaterial (hit);
//		} else if (Physics.Raycast (Util.RigidBodyPosition (rigidBody), Vector3.up, out hit, 20, oceanLayer)) {
//			Debug.Log (hit);
//			return CalculateOceanLevelFromMaterial (hit);
//		} else {
//			return oceanLevel;
...
//	}
//
//	private float CalculateOceanLevelFromMaterial(RaycastHit hit){
//		Vector3 position = Util.RigidBodyPosition (rigidBody);
//		return hit.transform.GetComponent<LPWAsset.LowPolyWaterScript> ().WaterHeight (position);
//	}
