...
uniform f4 LSky_Color;
uniform f4 LSky_Dir;
uniform f4 LSky_CloudColor;
uniform f4 LSky_CloudIntensity;
...
//	final = lerp(_Shading.rgb, _BaseColor.rgb, final);
	final = lerp(_Shading.rgb, LSky_CloudColor.rgb, final);
...
//	light.dir = _WorldSpaceLightPos0.xyz;
	light.dir = LSky_Dir.xyz;
	light.color = LSky_CloudColor;
