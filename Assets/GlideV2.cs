...
//			if (yaw > 0) {
//				leftDirection += transform.forward * yaw * yawScale;
//			}
			if (roll < 0) {
				leftDirection -= transform.right * roll * rollScale;
...
//			if (yaw < 0) {
//				rightDirection -= transform.forward * yaw * yawScale;
//			}
			if (roll > 0) {
				rightDirection -= transform.right * roll * rollScale;
